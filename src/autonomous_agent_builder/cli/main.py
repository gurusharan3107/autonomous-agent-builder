...
app.command(name="lint", help="Fast structural lint across builder product surfaces.")(lint.lint_command)
app.command(name="quality-gate", help="Local quality-gate surfaces.")(gate.quality_gate_command)
app.command(name="verify", help="Plan or execute behavioral proof for builder changes.")(verify.verify_command)
