...
from autonomous_agent_builder.cli.commands import approval, item, project, run, task
...
app = typer.Typer(
    help=(
        ...
        "  builder backlog item list --project <id> --json\n"
        "  builder backlog task list --json\n"
    )
)

app.add_typer(project.app, name="project", help="Repo-local project scope.")
app.add_typer(item.app, name="item", help="Typed backlog items.")
