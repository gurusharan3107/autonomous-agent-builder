...
def create_item(
    ...
    item_type: str = typer.Option("feature", "--type", help="feature, improvement, optimization, incident."),
    ...
    severity: str | None = typer.Option(None, help="Incident severity: low, medium, high, critical."),
    source: str = typer.Option("manual", help="manual, validation, agent, system."),
    evidence: str = typer.Option("", help="Required for incidents; reproduction or observed evidence."),
...
def update_item(
    ...
    status: str | None = typer.Option(None, help="Backlog item status, for example backlog, queued, or done."),
    item_type: str | None = typer.Option(None, "--type", help="feature, improvement, optimization, incident."),
    ...
    severity: str | None = typer.Option(None, help="Incident severity: low, medium, high, critical. Use an empty string to clear."),
    source: str | None = typer.Option(None, help="manual, validation, agent, system."),
    evidence: str | None = typer.Option(None, help="Observed evidence. Use an empty string to clear."),
