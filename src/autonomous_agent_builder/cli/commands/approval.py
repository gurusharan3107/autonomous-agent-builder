...
def list_approvals(
    ...
    try:
        ...
        render(
            compact_results_payload(
                "list", compact, next_step="builder backlog approval summary <query> --json"
            )
            if json
            else compact,
            fmt,
...
def search(
    ...
    try:
        ...
        render(
            compact_results_payload(
                query, compact, next_step="builder backlog approval summary <query> --json"
            )
            if json
            else compact,
            fmt,
...
def submit(
    ...
    decision: str = typer.Option(..., help="Decision: approve, reject, override, request_changes."),
