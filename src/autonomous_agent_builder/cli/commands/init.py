...
def init_command(
    ...
    framework: str = typer.Option(
        None,
        "--framework",
        help="Framework (django, fastapi, express, spring).",
    ),
    ...
    try:
        ...
        def fmt(d: dict) -> str:
            ...
            guidance = d.get("runtime_guidance", {})
            guidance_path = guidance.get("relative_path", "unknown")
            ...
            lines = [
                ...
                f"  Runtime guidance: {guidance_path} ({guidance_status})",
                f"  Readiness: {d.get('readiness', {}).get('state', 'unknown')}",
                "",
                "Next steps:",
