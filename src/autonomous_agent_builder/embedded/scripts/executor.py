...
class ScriptExecutor:
    ...
    def load_script(self, script_name: str) -> Script | None:
        ...
        try:
            ...
            for attr_name in dir(module):
                ...
                if isinstance(attr, type) and issubclass(attr, Script) and attr is not Script:
                    return attr()
    ...
    def execute_script(self, script_name: str, args: dict[str, Any] | None = None) -> ScriptResult:
