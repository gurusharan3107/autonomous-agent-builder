...
DOC_TYPE_SECTION_BUDGETS: dict[str, list[dict[str, Any]]] = {
    "context": [
        {
            "heading": "Overview",
            "purpose": "State what the operator should understand first.",
            "min_words": 30,
            "max_words": 90,
        },
        {
            "heading": "Key points",
            "purpose": "Capture the main reusable takeaways.",
            "min_words": 30,
            "max_words": 140,
        },
        {
            "heading": "Constraints or caveats",
            "purpose": "List boundaries, risks, and things that change the decision.",
            "min_words": 20,
            "max_words": 120,
        },
        {
            "heading": "Operational next step",
            "purpose": "Say what to do with this knowledge next.",
            "min_words": 12,
            "max_words": 60,
        },
    ],
    "adr": [
        {
            "heading": "Status",
            "purpose": "Record the current ADR state in one concise line.",
            "min_words": 1,
            "max_words": 12,
        },
        {
            "heading": "Context",
            "purpose": "Explain the problem and forcing conditions.",
            "min_words": 35,
            "max_words": 140,
        },
        {
            "heading": "Decision",
            "purpose": "State the chosen path clearly.",
            "min_words": 35,
            "max_words": 160,
        },
        {
            "heading": "Consequences",
            "purpose": "List expected benefits, costs, and tradeoffs.",
            "min_words": 20,
            "max_words": 140,
        },
    ],
    "api_contract": [
        {
            "heading": "Overview",
            "purpose": "Describe the contract surface and intended use.",
            "min_words": 30,
            "max_words": 100,
        },
        {
            "heading": "Endpoints or operations",
            "purpose": "List the callable surfaces that matter.",
            "min_words": 30,
            "max_words": 180,
        },
        {
            "heading": "Request and response details",
            "purpose": "Show the fields, shapes, and important constraints.",
            "min_words": 35,
            "max_words": 220,
        },
        {
            "heading": "Failure modes",
            "purpose": "Describe errors, edge cases, and expected handling.",
            "min_words": 20,
            "max_words": 120,
        },
    ],
    "schema": [
        {
            "heading": "Overview",
            "purpose": "Summarize what this schema governs.",
            "min_words": 25,
            "max_words": 90,
        },
        {
            "heading": "Entities or models",
            "purpose": "List the core entities and their responsibilities.",
            "min_words": 35,
            "max_words": 180,
        },
        {
            "heading": "Relationships",
            "purpose": "Explain how entities connect.",
            "min_words": 20,
            "max_words": 120,
        },
        {
            "heading": "Constraints",
            "purpose": "State integrity rules and invariants.",
            "min_words": 20,
            "max_words": 120,
        },
    ],
    "runbook": [
        {
            "heading": "Purpose",
            "purpose": "State when to use this runbook.",
            "min_words": 20,
            "max_words": 70,
        },
        {
            "heading": "Preconditions",
            "purpose": "List prerequisites and required state.",
            "min_words": 15,
            "max_words": 90,
        },
        {
            "heading": "Procedure",
            "purpose": "Lay out the actual operating steps.",
            "min_words": 40,
            "max_words": 240,
        },
        {
            "heading": "Verification",
            "purpose": "Explain how to confirm success.",
            "min_words": 15,
            "max_words": 90,
        },
        {
            "heading": "Rollback or escalation",
            "purpose": "State fallback and escalation moves.",
            "min_words": 15,
            "max_words": 90,
        },
    ],
    "system-docs": [
        {
            "heading": "Overview",
            "purpose": "Summarize the surface and why it matters.",
            "min_words": 30,
            "max_words": 80,
        },
        {
            "heading": "Boundaries",
            "purpose": "Name the owning paths, entrypoints, and adjacent surfaces.",
            "min_words": 20,
            "max_words": 90,
        },
        {
            "heading": "Invariants",
            "purpose": "List the facts or contracts that must remain true during changes.",
            "min_words": 20,
            "max_words": 120,
        },
        {
            "heading": "Evidence",
            "purpose": "Preserve the detailed proof, subsections, diagrams, and examples.",
            "min_words": 60,
            "max_words": 420,
        },
        {
            "heading": "Change guidance",
            "purpose": "Say how an operator or agent should change and verify this surface.",
            "min_words": 12,
            "max_words": 60,
        },
    ],
    "feature": [
        {
            "heading": "Overview",
            "purpose": "Describe the capability and why it matters.",
            "min_words": 24,
            "max_words": 80,
        },
        {
            "heading": "Current behavior",
            "purpose": "Explain the live implementation, outcomes, and constraints.",
            "min_words": 30,
            "max_words": 140,
        },
        {
            "heading": "Boundaries",
            "purpose": "Name the owning paths, routes, jobs, and adjacent surfaces.",
            "min_words": 20,
            "max_words": 90,
        },
        {
            "heading": "Verification",
            "purpose": "Point to the testing doc or exact checks that prove this feature works.",
            "min_words": 18,
            "max_words": 100,
        },
        {
            "heading": "Change guidance",
            "purpose": "Explain when this doc must be refreshed after changes.",
            "min_words": 12,
            "max_words": 70,
        },
    ],
    "testing": [
        {
            "heading": "Purpose",
            "purpose": "State the verification objective.",
            "min_words": 18,
            "max_words": 70,
        },
        {
            "heading": "Coverage",
            "purpose": "List the flows, endpoints, or UI paths covered.",
            "min_words": 18,
            "max_words": 110,
        },
        {
            "heading": "Preconditions",
            "purpose": "List data, services, credentials, and setup requirements.",
            "min_words": 12,
            "max_words": 90,
        },
        {
            "heading": "Procedure",
            "purpose": "Lay out the exact validation steps the agent should follow.",
            "min_words": 30,
            "max_words": 200,
        },
        {
            "heading": "Evidence and follow-up",
            "purpose": "Describe what proof to capture and what makes the doc stale.",
            "min_words": 18,
            "max_words": 120,
        },
    ],
    "metadata": [
        {
            "heading": "Summary",
            "purpose": "Explain what was generated and when.",
            "min_words": 12,
            "max_words": 70,
        },
        {
            "heading": "Generated artifacts",
            "purpose": "List the created documents.",
            "min_words": 15,
            "max_words": 140,
        },
        {
            "heading": "Usage",
            "purpose": "Explain how to use the generated set.",
            "min_words": 12,
            "max_words": 70,
        },
    ],
    "raw": [
        {
            "heading": "Insight",
            "purpose": "State the distilled claim or takeaway.",
            "min_words": 30,
            "max_words": 90,
        },
        {
            "heading": "Evidence",
            "purpose": "Give the proof, quote context, or concrete support.",
            "min_words": 20,
            "max_words": 90,
        },
        {
            "heading": "Applicability",
            "purpose": "Translate the insight into operational use.",
            "min_words": 20,
            "max_words": 90,
        },
    ],
...
def contract_prompt_block(doc_type: str, sample_title: str, tags: list[str]) -> str:
    ...
    sample_body = f"# {sample_title}\n\nWrite the article body here."
    markdown_template = build_document_markdown(
        title=sample_title,
        tags=tags,
        doc_type=doc_type,
        body=sample_body,
...
class DocumentLinter:
    ...
    def _validate_maintained_doc_metadata(
        ...
        if refresh_required is True and not frontmatter.get("updated"):
            self.errors.append(f"{source}: refresh_required maintained docs require 'updated'")

        if doc_type == "testing" or doc_family == "testing":
            last_verified_at = str(frontmatter.get("last_verified_at", "") or "").strip()
            if not last_verified_at:
                self.errors.append(f"{source}: testing docs require 'last_verified_at'")
    ...
    def _validate_body(self, body: str, frontmatter: dict[str, Any], source: str) -> None:
        ...
        if len(body) < min_length:
            self.warnings.append(f"{source}: Document body is very short ({len(body)} chars)")
    ...
    def _validate_markdown(self, body: str, frontmatter: dict[str, Any], source: str) -> None:
        ...
        if isinstance(doc_type, str):
            available_h2 = {
                self._normalize_heading(title) for level, title, _ in headings if level == 2
            }
            missing = [
                section.replace("## ", "")
        ...
        for index, (level, heading_text, start) in enumerate(headings):
            ...
            if level > 1 and not section_text:
                self.errors.append(f"{source}: Section '{heading_text}' has no body content")
                continue
            ...
            if level == 2 and isinstance(doc_type, str):
                for budget in section_budget_guidance(doc_type):
                    if self._normalize_heading(budget["heading"]) != self._normalize_heading(
                        heading_text
                    ):
                        continue
