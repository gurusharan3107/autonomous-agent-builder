...
AGENT_DEFINITIONS: dict[str, AgentDefinition] = {
    ...
    "gate-remediator": AgentDefinition(
        ...
        prompt_template=(
            ...
            "A quality gate failed in the workspace at {workspace_path}. "
            "Your ONLY job is to fix the specific error reported below — "
            "nothing else. Do not change business logic, component behavior, "
            "or test assertions. Do not add features or refactor working code.\n\n"
            "Gate: {gate_name}\n"
            ...
            "- Never delete any file — only edit existing files or create missing "
            "  config/declaration files.\n"
            "- Allowed fixes: add missing .d.ts files, edit tsconfig*.json, "
            "  edit vite.config.ts, add vitest reference, create index.html if "
            "  absent, edit package.json scripts.\n\n"
            "Output discipline:\n"
            ...
            "\"reason\": \"<why it cannot be auto-fixed, one sentence>\"}}\n\n"
            "{tool_context}\n\n"
            "Task: {task_title}\n"
            "Language: {language}\n"
            "Workspace: {workspace_path}\n"
