...
AGENT_DEFINITIONS: dict[str, AgentDefinition] = {
    ...
    "optimization-agent": AgentDefinition(
        ...
        prompt_template=(
            ...
            "`builder logs analyze --json`, and task/run summaries before selecting a candidate. "
...
SUBAGENT_DEFINITIONS: dict[str, SubagentDefinition] = {
    ...
    "browser-verifier": SubagentDefinition(
        ...
        description=(
            "Claude specialist for browser-visible acceptance evidence and UI "
    ...
    "build-verifier": SubagentDefinition(
        name="build-verifier",
        description=(
            "Claude specialist for deterministic build, lint, test, and changed-file "
            "evidence."
        ),
        prompt=(
    ...
    "security-reviewer": SubagentDefinition(
        ...
        description=(
            "Claude specialist for security and permission-risk evidence on changed "
            "surfaces."
        ),
        prompt=(
