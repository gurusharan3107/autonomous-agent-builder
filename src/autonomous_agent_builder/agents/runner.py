...
class AgentRunner:
            ...
            if self._is_empty_sdk_result(result):
                ...
                if self._is_empty_sdk_result(result):
                    return RunResult(
                        ...
                        error=(
                            "Empty SDK result: no assistant text, token usage, "
                            "or cost was returned"
                        ),
    ...
    async def _execute_query(
        ...
        options = ClaudeAgentOptions(
            ...
            task_budget={"total": runtime_policy.task_budget_tokens} if runtime_policy.task_budget_tokens else None,
            extra_args={
