...
async def builder_task_recover(task_id: str, *, project_root: str | None = None) -> dict:
    """Recover a blocked, failed, or capability-limited task for redispatch."""
    return await builder_tool_service.builder_task_recover(task_id, project_root=project_root)
...
async def builder_backlog_item_list(
    ...
    *,
    ...
    """List typed backlog items, defaulting to the repo's current project."""
...
async def builder_backlog_item_show(item_id: str, *, project_root: str | None = None) -> dict:
...
CLI_TOOLS = {
    ...
    "builder_backlog_item_list": builder_backlog_item_list,
    "builder_backlog_item_show": builder_backlog_item_show,
