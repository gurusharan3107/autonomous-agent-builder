...
Retrieve this memory when working on steering, implementation, or related pattern changes. Use it to preserve the repo-local precedent: Approach When encountering recurring friction (interactive commands, platform issues, tool misuse), encode the solution in steering files rather than relying on memory or repeated corrections.

## User-Facing Summary

Approach When encountering recurring friction (interactive commands, platform issues, tool misuse), encode the solution in steering files rather than relying on memory or repeated corrections.

## Reusable Guidance

- Treat this as repo-local pattern precedent for steering.
...
Apply this when changes touch steering, the implementation phase, or related tags: friction, commands, windows, automation.
