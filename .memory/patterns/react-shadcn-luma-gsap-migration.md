...
Retrieve this memory when working on frontend, implementation, or related pattern changes. Use it to preserve the repo-local precedent: Approach Specific gotchas and patterns discovered during the Vite+React+shadcn/Luma migration.

## User-Facing Summary

Approach Specific gotchas and patterns discovered during the Vite+React+shadcn/Luma migration.

## Reusable Guidance

- Treat this as repo-local pattern precedent for frontend.
...
Apply this when changes touch frontend, the implementation phase, or related tags: react, shadcn, gsap, spa, vite.

## Retrieval Queries

- react + shadcn luma + gsap migration patterns
- react shadcn luma gsap migration
- frontend
- implementation
- react
- shadcn
