...
class TestNonClaudeRuntimes:
    ...
    def test_codex_subscription_env_strips_openai_api_key(self, monkeypatch):
        from autonomous_agent_builder.services.codex_subscription_env import (
            codex_subscription_env,
        )

        monkeypatch.setenv("OPENAI_API_KEY", "realtime-only")
