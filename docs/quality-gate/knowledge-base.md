...
expectations:
  ...
  - "reverse-engineering readiness depends on deterministic KB validation, not advisory output"
...
Reverse-engineering readiness depends on this deterministic result, not on
agent advisory output. Forward-engineering readiness marks KB extraction and
validation as skipped until the initial scope and architecture are concrete.
