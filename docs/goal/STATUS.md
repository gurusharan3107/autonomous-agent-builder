...
| Last Update | 2026-05-23 — M2.3 telemetry honesty: `builder logs analyze --session <id>` is now session-scoped via `tasks.chat_session_id` FK. Unblocks M3.5 σ-floor. M3.5 D1 (N=5 baseline) remains operator-triggered. |
