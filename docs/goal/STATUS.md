...
| Last Update | 2026-06-16 — Stabilization tick: restored the green `ruff check .` CI floor (157→0; was red ~12 days, blocking pytest in CI). Lint-only; `ruff format` (216 files) deferred. 034b frontend + 035b/c + live-verify still pending. |
