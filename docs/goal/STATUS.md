...
| Last Update | 2026-05-23 — Freshness sweep script lands as the discipline layer for Hard Rule 2. Skill closeouts now call `freshness_sweep.py` and refuse to close on exit 1. M2.3 telemetry honesty + skill restructure both standing. M3.5 D1 (N=5 baseline) remains operator-triggered. |
