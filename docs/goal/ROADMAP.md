...
- [x] **G1 — `include_partial_messages=True` on Claude lane `ClaudeSDKClient`.** Added to all three construction sites; `StreamEvent` handled in message loop (per-turn usage extraction wired in follow-up). *(2026-05-22)*
