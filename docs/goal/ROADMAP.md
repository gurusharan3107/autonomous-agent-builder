...
- [ ] **goal-audit memory write**: `builder memory add --type pattern --tag goal-audit,intent-extraction` recording "prefer recency-ranked intent over token-weighted intent" per FIX-STANDARD.md § Step 7. Surfaced in Run #3.
