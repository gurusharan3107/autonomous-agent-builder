...
- queued sprint tasks have been dispatched by the orchestrator and are no longer
  merely visible Board cards
...
- task activity timeline events that show meaningful file or action deltas while
  the agent is running, without exposing the full transcript
