        ...
        <div className="grid gap-5 p-5 md:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)]">
          <div className="space-y-4">
            ...
            <div className="grid gap-2">
              <RuntimeMetricRow label="SDK" value={runtimeSettings?.sdk ?? "loading"} tone="active" />
          ...
          >
            ...
            {ready ? (
              ...
              >
                ...
                <UtilityButton icon={<Command className="h-3.5 w-3.5" />} label="Settings" onClick={() => setSystemOpen(true)} />
                <ThemeToggle />
              </div>
            ) : (
              <div
