...
function runtimeGlyph(icon?: TimelineEntry["icon"]) {
    ...
    return (
      <span className="inline-flex h-3.5 w-3.5 items-center justify-center" aria-hidden="true">
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
          ...
          <path
            d="M9.2 7.5 13 12l-3.8 4.5M14.2 16.5h3.4"
            stroke="currentColor"
            strokeWidth="2.4"
            strokeLinecap="round"
  ...
  if (icon === "claude") {
    return (
      <span
        className="inline-flex h-3.5 w-3.5 items-center justify-center text-status-review"
        aria-hidden="true"
      >
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
          <path
            d="M12 2.4v6.2M12 15.4v6.2M4.1 5.4l4.4 4.4M15.5 14.2l4.4 4.4M2.4 12h6.2M15.4 12h6.2M4.1 18.6l4.4-4.4M15.5 9.8l4.4-4.4"
            stroke="currentColor"
            strokeWidth="2.7"
            strokeLinecap="round"
          />
