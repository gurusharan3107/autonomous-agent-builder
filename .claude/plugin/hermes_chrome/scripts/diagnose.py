#!/usr/bin/env python3
"""CLI wrapper for the deterministic Hermes Chrome Bridge diagnostics.

Used by the hermes-chrome skill preflight (step 1) to catch setup regressions
...
def main() -> int:
    ...
    if as_json:
        ...
        print(f"hermes-chrome diagnose [{report['platform']}] → {verdict}")
