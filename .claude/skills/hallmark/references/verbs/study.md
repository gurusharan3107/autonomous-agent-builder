...
> Loaded on demand when the operator invokes 'hallmark study <screenshot|URL>'. Extracts the DNA — macrostructure, archetypes, type-pairing, colour anchor — and produces a diagnosis report. See [study.md](../study.md) for the deep extraction protocol this verb implements.
