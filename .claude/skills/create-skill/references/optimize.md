...
1. **Audit first** — `python3 .claude/skills/create-skill/scripts/audit.py <skill>`. **Never edit blind.** The audit JSON is the input to this lane.
...
python3 .claude/skills/create-skill/scripts/audit.py <skill-path>
...
1. Read `.claude/skills/hallmark/SKILL.md` to understand the lane structure.
