...
python3 .claude/skills/create-skill/scripts/audit.py .claude/skills/<name>

# Repo-wide sweep — every SKILL.md under .claude/skills/.
...
python3 .claude/skills/create-skill/scripts/audit.py --all --strict

# Machine-readable output for downstream tooling.
python3 .claude/skills/create-skill/scripts/audit.py --all --json
```
