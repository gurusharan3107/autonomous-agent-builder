...
Checks (each isolated; one drift doesn't short-circuit the rest):
  ...
  - autoresearch-explainer.html AUTOUPDATE fences (baseline-summary,
    baseline-scatter, baseline-raw-rows, iterations-list) intact —
    render_iterations.py depends on them.
